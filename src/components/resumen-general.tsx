...
// Resumen general (todo el histórico por método, mes y tienda). Vive como
// pestaña "Consolidado" de Tiendas y en /resumen
export function ResumenGeneral() {
  ...
  return (
    <>
      {api?.cut.sales && (
        <p className="text-xs text-gray-500">Totalizado de todo el histórico cargado, al {formatDate(api.cut.sales)}</p>
      )}
